...
![Prediction Result](https://github.com/archeltaneka/udacity-deep-learning-project-1-bike-sharing-pattern/tree/master/project-bikesharing/assets/result.png)
------------------------------------------------------
## Prerequisites
- Python 3.x
- Numpy v1.19
